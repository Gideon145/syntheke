...
$vars = @(
  ...
  "XLAYER_CHAIN_ID=196",
  "MAINNET_SYNTHEKE_CONTRACT=0x91ddd53ea56519e6f33231e76112a3643fd24f0b",
  "LEGACY_SYNTHEKE_CONTRACTS=0x2693Bab68Fa76b9DF585416672c1363FA5b0fE7A",
  "SERVICE_PRICE_USD=0.1",
  "X402_SETTLED_BASELINE=13",
